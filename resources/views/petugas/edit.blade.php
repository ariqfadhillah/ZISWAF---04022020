					...
					<div class="panel">
						<div class="panel-body">
							<form action="/petugas/{{$petugas->id}}/update" method="post" enctype="multipart/form-data">
								...
								<input name="nama_petugas" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Petugas Rekap" value="{{$petugas->nama_petugas}}">
