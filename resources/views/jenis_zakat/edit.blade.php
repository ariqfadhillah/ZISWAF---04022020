					...
					<div class="panel">
						<div class="panel-body">
							<form action="/jenis_ziswaf/{{$jenis_ziswaf->id}}/update" method="post" enctype="multipart/form-data">
								...
								<input name="jenis_ziswaf" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Jenis Zakatnya" value="{{$jenis_ziswaf->jenis_ziswaf}}" required>
